...
describe('CLASS Avaliacao', () => {
  describe('INSTANCIAÇÃO', () => {
    ...
    test('erro ao instanciar uma avaliação', () => {
      ...
      const avaliacao2 = new Avaliacao('Creche Dona Francisca', 'Pamela','A creche é espaçosa, arejada e segura (possui grades e sistema de segurança eletrônico com camêras). O corpo docente é qualificado e seguem as orientações do MEC com vigor, os demais funcionários/as são sempre educados e prestativos.', 8)
